...
//                 <TourInfo info = {tour.info} includedInfo = {tour.includedInfo}/>
...
const TourPageAbout = ({ page, section }) => {
  const lightness = section?.backgroundTone === "light" ? "light" : "dark";
